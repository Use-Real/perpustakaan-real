                ...
                <div class="card">
                    ...
                    <form action="" method="post">
                        <div class="card-body">
                            ...
                            <div class="row mb-2">
                                <a href="login.php" type="btn" class="btn btn-danger">Batal</a>
                            </div>
...
<?php 
    ...
    if(isset($_POST['btnDaftar'])){
        ...
        $query=mysqli_query($con,"INSERT INTO tb_user VALUES('$username','$password')");

        if($query){
            echo "
                <script>
                    alert('User Telah Didaftarkan');
